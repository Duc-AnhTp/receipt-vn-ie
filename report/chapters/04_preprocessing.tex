...
Trước khi đưa dữ liệu vào mô hình, hình ảnh và văn bản đều trải qua các bước chuẩn hóa và tăng cường dữ liệu. Các cấu hình tiền xử lý hiện được giữ mặc định theo thiết lập hệ thống và chưa qua các thực nghiệm ablation để so sánh sâu hơn. Các bước xử lý này đều có ảnh hưởng đáng kể đến chất lượng trích xuất thông tin ở các giai đoạn sau.
