...
Việc đánh giá hai hướng tiếp cận trên cùng tập kiểm thử giúp mô tả ưu, nhược điểm của các checkpoint hiện có. Tuy nhiên, một phép so sánh kiến trúc tuyệt đối còn đòi hỏi kiểm soát lượng dữ liệu và mức annotation giống nhau.
...
\begin{itemize}
  \item \textbf{RQ1:} Trên các prediction artifact đủ điều kiện đánh giá, mô hình OCR-based \model{LayoutXLM} cải thiện như thế nào so với Baseline dựa trên luật? Artifact hiện có cho phép kết luận đến đâu về \model{Donut}?
...
\begin{enumerate}
  ...
  \item \textbf{Đánh giá có kiểm soát bằng chứng:} So sánh Baseline và \model{LayoutXLM} trên cùng tập kiểm thử, đồng thời tách artifact \model{Donut} không hoàn chỉnh sang phạm vi chẩn đoán thay vì dùng để xếp hạng.
...
\begin{itemize}
  ...
  \item \textbf{\cref{sec:experiments} (Thực nghiệm):} Trình bày cấu hình, phạm vi dữ liệu, protocol đánh giá và giới hạn bằng chứng huấn luyện.
  \item \textbf{\cref{sec:results} (Kết quả thực nghiệm):} Thảo luận kết quả all-samples, present-only, latency thành phần và phân tích lỗi tái lập.
