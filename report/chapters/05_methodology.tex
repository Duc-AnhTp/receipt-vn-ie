...
Cấu hình và mã suy luận hiện tại đặt \code{max\_length=768}. Tuy nhiên, prediction artifact dùng trong báo cáo được tạo trước khi tham số này được truyền tường minh và đã kế thừa mặc định 20 token của Transformers. Có 225/234 chuỗi đích dài hơn giới hạn này và 173/234 output chạm giới hạn sinh. Vì vậy artifact được giữ để chẩn đoán lỗi cấu hình, không dùng trong bảng xếp hạng chất lượng hoặc latency chính.
\end{warnbox}
