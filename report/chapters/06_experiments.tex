...
\begin{itemize}
  ...
  \item Donut: thời gian suy luận và hậu xử lý trực tiếp từ ảnh.
\end{itemize}

Thời gian chạy PaddleOCR và VietOCR từ ảnh thô không được ghi đồng nhất trong các prediction hiện có. Vì vậy báo cáo không cộng một hằng số OCR giả định và không gọi bảng latency này là so sánh end-to-end công bằng.
