...
Baseline và LayoutXLM có đủ 234 prediction, không có bản ghi \code{status=error} và được dùng trong so sánh chính. Với LayoutXLM, bốn prediction cũ dùng hộp OCR trên ảnh resize nhưng chuẩn hóa tọa độ theo kích thước ảnh thô; báo cáo giữ nguyên artifact và bổ sung sensitivity check loại bốn ID này. Donut có đủ số bản ghi nhưng lượt sinh bị cắt ở 20 token, nên chỉ được dùng cho chẩn đoán. SHA-256 trong bảng khóa đúng nội dung các artifact được phân tích.
...
\begin{itemize}
  ...
  \item Donut: artifact có thời gian suy luận trực tiếp từ ảnh, nhưng phép đo bị ảnh hưởng bởi việc dừng sinh ở 20 token và chỉ được trình bày trong bảng chẩn đoán.
\end{itemize}
