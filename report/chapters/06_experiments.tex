...
Phần này đi vào cấu hình lưu trong repository, phạm vi dữ liệu mỗi mô hình dùng, và cách tạo các artifact phục vụ đánh giá. Những thông tin không còn log gốc để kiểm chứng (thời gian huấn luyện, epoch dừng thực tế) sẽ không được đưa ra như kết quả đo.
...
Cả ba phương pháp Baseline, LayoutXLM và Donut đều có đủ 234 bản ghi dự đoán trên tập test, không có bản ghi nào bị lỗi (\code{status=error}), và đều được đưa vào bảng kết quả để người đọc thấy cùng một protocol đánh giá. Riêng LayoutXLM, báo cáo có thêm sensitivity check loại bốn ID bị sai lệch tọa độ ảnh. Với Donut, metadata của prediction ghi nhận tham số sinh \code{generation\_max\_length=768}; tuy nhiên đầu ra vẫn lặp mạnh và rất ít cặp thẻ hợp lệ, nên kết quả Donut được diễn giải như chẩn đoán checkpoint hiện có hơn là kết luận tổng quát về toàn bộ hướng OCR-free. SHA-256 trong bảng khóa đúng nội dung các artifact được phân tích.
