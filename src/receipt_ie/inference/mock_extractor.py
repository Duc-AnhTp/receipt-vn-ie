    ...
    def predict(self, image: Image.Image) -> Dict[str, Any]:
        ...
        if self.method == "donut":
            ...
            return {
                ...
                "latency_model_ms": res.get("latency_model_ms", 0.0) * 1.1,
                "latency_postprocess_ms": res.get("latency_postprocess_ms", 0.0) * 1.1,
                "latency_e2e_ms": res.get("latency_e2e_ms", 0.0) * 1.1,
                "status": "ok",
                "is_mock": True
            }
        else: # layoutxlm
            ...
            return {
                ...
                "latency_model_ms": res.get("latency_model_ms", 0.0) * 1.2,
                "latency_postprocess_ms": res.get("latency_postprocess_ms", 0.0) * 1.2,
                "latency_e2e_ms": res.get("latency_e2e_ms", 0.0) * 1.2,
                "status": "ok",
                "words": words,
