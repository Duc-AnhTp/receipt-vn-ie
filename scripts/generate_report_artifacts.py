...
\begin{{table}}[htbp]
  \centering
  \caption{{Post-OCR / cached inference latency. Phép đo của Baseline và LayoutXLM bắt đầu sau OCR cache; Donut bắt đầu trực tiếp từ ảnh đầu vào. \textbf{{OCR time: not measured in this comparison}}.}}
