...
class TestOcrPipeline(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        # Tạo ảnh mock chứa chữ vẽ đơn giản để test detector & recognizer
        ...
        # Khởi tạo models (sử dụng CPU để chạy nhanh và ổn định trong test)
    ...
    def test_detection(self):
        ...
        # Không bắt buộc detector phải nhận diện chính xác các ô đen vẽ
        # nhưng đảm bảo hàm không crash và trả về list
    ...
    def test_recognition_and_crop(self):
